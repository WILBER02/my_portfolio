...
|---|---|---|
| `YOUR-PORTFOLIO-URL.com` | canonical, og:url, og:image / twitter:image, JSON-LD, contact card | Your live site URL |
Already filled in (`index.html`): LinkedIn → `https://www.linkedin.com/in/wilberforce-muhuyi-49762a39a/`, GitHub → `https://github.com/WILBER02`, email → `wilberforcemuhuyi28@gmail.com`,
